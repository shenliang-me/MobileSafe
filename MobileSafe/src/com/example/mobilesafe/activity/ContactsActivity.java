...
public class ContactsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lvContact.setAdapter(new SimpleAdapter(this, list, R.layout.list_item_contact, new String[] { "name", "phone" },
	...
	private ArrayList<HashMap<String, String>> readContact() {
		...
		Cursor rawContactCursor = getContentResolver().query(Uri.parse("content://com.android.contacts/raw_contacts"),
		...
		while (rawContactCursor.moveToNext()) {// 遍历所有联系人
			...
			Cursor dataCursor = getContentResolver().query(Uri.parse("content://com.android.contacts/data"),
